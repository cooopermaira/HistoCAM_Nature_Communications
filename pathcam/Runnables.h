...
namespace pathCam {
  ...
  public:
    ...
    ComponentMatchSearch(StreamCam *_parent, Image *_image,std::shared_ptr<Composite> _component, std::vector<Image*> candidates_) : parent(_parent),component(_component),
